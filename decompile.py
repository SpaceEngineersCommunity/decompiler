...
def check(args: argparse.Namespace) -> None:
    ...
    if not shutil.which('dotnet'):
        # ILSpy is based on .NET 8.0 as of 2025-06
        print('required: dotnet: apt install dotnet-sdk-8.0 dotnet-sdk-9.0')
        exit(1)
    if not shutil.which('ilspycmd'):
        ...
        print('then put ilspycmd in your PATH, e.g. sudo ln -s $PWD/ICSharpCode.ILSpyCmd/bin/Release/net8.0/ilspycmd /usr/local/bin/ilspycmd')
        exit(1)
